...
const ProjectForm = ({ type, session, project }: Props) => {
    ...
    const handleFormSubmit = async (e: FormEvent) => {
        ...
        console.log('Form Submit Token:', token)
        try {
            if (type === "create") {
    ...
    return (
        <form
            ...
            <FormField
                ...
                placeholder="Please paste URL of deployed page starting with https://"
            ...
            <FormField
                ...
                placeholder="Please paste URL of GitHub project starting with https://"
